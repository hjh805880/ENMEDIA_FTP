...
<template>
  <div>
    ...
    <section id="section3" class="text-white w-screen overflow-hidden bg-fixed bg-[url('~/assets/img/section3_visual_bg.webp')] bg-cover bg-center text-center bg-no-repeat">
      <div class="lg:max-w-gui colCenter lg:px-12 lg:py-40 lg:space-y-40 max-w-full px-4 py-32 mx-auto space-y-20">
        <div data-aos="fade-up" data-aos-duration="1000" class="colCenter space-y-4">
        ...
        <PortfolioList data-aos="fade-up" data-aos-duration="1200" class="" :maxItems="10" :categoryButtons="false" @selectItem="selectedItem = $event" />
    ...
    <section id="section5" class="bg-[url('~/assets/img/section5_visual_bg.webp')] w-full overflow-visible text-center text-white bg-center bg-no-repeat bg-cover">
      <div class="lg:max-w-gui max-w-full colCenter relative lg:px-12 px-4 lg:pt-40 pt-32 lg:pb-[42%] pb-[180vmin] mx-auto">
    ...
    <!-- 섹션6 시작 -->
    <section id="section6" class="text-black-800 lg:mt-[40%] mt-[172vmin] w-full h-full text-center bg-white">
      <div class="lg:max-w-gui colCenter lg:px-12 lg:pb-40 relative max-w-full px-4 pb-32 mx-auto space-y-16">
        <div data-aos="fade-up" data-aos-duration="1000" class="colCenter space-y-4 overflow-hidden">
          <h2 class="lg:text-4xl lg:pb-4 pb-2 text-3xl font-extrabold">LOCATION</h2>
          <div class="border-primary-500 lg:w-12 w-10 border-b-8"></div>
          <h3 class="lg:text-xl pt-1 text-lg font-light">이엔미디어는 성장하고자 하는 모든 비즈니스에 열려있습니다.</h3>
        </div>
        <KakaoMap />
        <div class="grid w-full grid-cols-1 px-2 space-y-6 text-left">
          ...
          <div class="flex flex-col items-start justify-center space-y-2">
            ...
            <h5 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" class="text-black-700 lg:text-lg">발산역 9번출구에서 300M 직진</h5>
          </div>
          <div class="flex flex-col items-start justify-center space-y-2">
            <h4 data-aos="fade-up" data-aos-duration="1000" class="before:content-['-'] before:text-3xl before:mr-2 before:text-primary-500 lg:text-2xl text-xl font-bold">CONTACT INFO</h4>
            <NuxtLink data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" to="tel:02-3429-3161" class="rowCenter hover:underline hover:underline-offset-4 space-x-2">
