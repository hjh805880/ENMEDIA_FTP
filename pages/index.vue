...
<template>
  ...
  <section id="section2" class="text-black-800 w-screen overflow-hidden bg-[url('/img/section2_visual_bg.webp')] bg-cover text-center bg-center bg-no-repeat">
    <div class="max-w-gui space-y-14 px-12 py-32 mx-auto">
      ...
      <div class="grid grid-cols-4 gap-8">
        <NuxtLink data-aos="fade-up" date-aos-duration="1000" to="/company" class="aspect-1 group/company hover:border-primary-500 colCenter border-black-700 w-full p-4 space-y-4 bg-white border-2 rounded-full">
          <MainCompanyIcon />
          <h4 class="text-black-700 group-hover/company:text-primary-500 text-2xl font-bold">COMPANY</h4>
        </NuxtLink>
        <NuxtLink data-aos="fade-up" date-aos-duration="1200" to="/service" class="aspect-1 group/service colCenter hover:border-primary-500 border-black-700 w-full p-4 space-y-4 bg-white border-2 rounded-full">
          <MainServiceIcon />
          <h4 class="text-black-700 group-hover/service:text-primary-500 text-2xl font-bold">SERVICE</h4>
        </NuxtLink>
        <NuxtLink data-aos="fade-up" date-aos-duration="1400" to="/solution" class="aspect-1 group/solution colCenter hover:border-primary-500 border-black-700 w-full p-4 space-y-4 bg-white border-2 rounded-full">
          <MainSolutionIcon />
          <h4 class="text-black-700 group-hover/solution:text-primary-500 text-2xl font-bold">SOLUTION</h4>
        </NuxtLink>
        <NuxtLink data-aos="fade-up" date-aos-duration="1600" to="/portfolio" class="aspect-1 group/portfolio colCenter hover:border-primary-500 border-black-700 w-full p-4 space-y-4 bg-white border-2 rounded-full">
          <MainPortfolioIcon />
  ...
  <section id="section3" class="text-white w-screen overflow-hidden bg-fixed bg-[url('/img/section3_visual_bg.webp')] bg-cover bg-center text-center bg-no-repeat">
    <div class="max-w-gui space-y-14 colCenter px-12 py-32 mx-auto">
      ...
      <PortfolioList :maxItems="10" :showCategoryButtons="true" />
      <NuxtLink data-aos="fade-up" date-aos-duration="1000" to="/portfolio" class="hover:bg-white hover:text-primary-500 px-6 py-1 text-lg font-bold border-2 border-white rounded-full"> MORE PORTFOLIO </NuxtLink>
    </div>
  </section>
